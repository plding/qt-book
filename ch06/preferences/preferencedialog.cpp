    ...
    : QDialog(parent)
{
    ...
    stackedLayout->addWidget(webBrowswerPage);
...
void PreferenceDialog::createWebBrowserPage()
{
    ...
    locationLineEdit = new QLineEdit(tr("http://www.trolltech.com/"));
    ...
    webBrowswerPage->setLayout(pageLayout);
...
void PreferenceDialog::createAdvancedPage()
{
    ...
    featuresLayout->addWidget(javaCheckBox);
    featuresLayout->addWidget(ftpCheckBox);
    featuresLayout->addWidget(ftpLineEdit);
